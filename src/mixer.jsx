...
const INGREDIENTS_LIST = {
  "Base Alcohol": [
    { name: "Vodka", color: "#FFFFFF1A" },
    { name: "Gin", color: "#FFFFFF33" },
    { name: "White Rum", color: "#F8F8FF66" },
    { name: "Dark Rum", color: "#6F2E00B3" },
    { name: "Bourbon", color: "#C17A24B3" },
    { name: "Tequila", color: "#F2D26B99" },
    { name: "Rye Whiskey", color: "#B87333B3" },
    { name: "Reposado", color: "#B8860B99" },
    { name: "Mezcal", color: "#D2B48C99" },
    { name: "Brandy", color: "#8B4513B3" },
    { name: "Light Rum", color: "#F5F5DC99" },
    { name: "Whiskey", color: "#B87333B3" },
    { name: "Blanco Tequila", color: "#F0FFF099" },
    { name: "Irish Whiskey", color: "#C17A24B3" },
    { name: "Coconut Rum", color: "#F5F5F580" },
  ],
  "Fresh Juices": [
    { name: "Lime Juice", color: "#9ACD3299" },
    { name: "Lemon Juice", color: "#FFFACD99" },
    { name: "Orange Juice", color: "#FFA50099" },
    { name: "Cranberry Juice", color: "#9F2B6899" },
    { name: "Grapefruit Juice", color: "#b547ffb4" },
    { name: "Pineapple Juice", color: "#FFE13599" },
  ],
  "Liqueurs": [
    { name: "Coffee Liqueur", color: "#4A2C2A99" },
    { name: "Peach Schnapps", color: "#FFDAB999" },
    { name: "Triple Sec", color: "#FFA50080" },
    { name: "Amaretto", color: "#A52A2A99" },
    { name: "Cointreau", color: "#FF8C0080" },
    { name: "Irish Cream", color: "#f0b48cd3" },
    { name: "Creme de Cacao", color: "#6B442399" },
    { name: "Creme de Menthe", color: "#98FB9899" },
    { name: "Kalhua", color: "#4A2C2A99" },
    { name: "Benedictine", color: "#FFD70099" },
    { name: "Chambord", color: "#80008099" },
    { name: "Maraschino Liqueur", color: "#741a0e7e" },
    { name: "brown Creme de Cacao", color: "#6B442399" },
    { name: "green Creme de Cacao", color: "#32CD3299" },
    { name: "Hazelnut Liqueur", color: "#8B451399" },
    { name: "Melon Liqueur", color: "#90EE9099" },
  ],
  "Digestivos and Aperitivos": [
    { name: "Campari", color: "#E51A4C99" },
    { name: "Aperol", color: "#FF450099" },
    { name: "Fernet Branca", color: "#1A1A1A99" },
    { name: "Lillet Blanc", color: "#F5F5DC99" },
  ],
  "Sweeteners": [
    { name: "Simple Syrup", color: "#FFFFFF33" },
    { name: "Grenadine", color: "#E0115F99" },
    { name: "Honey Syrup", color: "#FFB30099" },
    { name: "Agave Syrup", color: "#176be8d0" },
    { name: "Sugar", color: "#FFFFFF80" },
    { name: "Orgeat Syrup", color: "#FFEBCD99" },
  ],
  "Bitters": [
    { name: "Angostura Bitters", color: "#7B111399" },
    { name: "Peychaud's Bitters", color: "#D7004099" },
    { name: "Orange Bitters", color: "#FF8C0099" },
  ],
  "Fortified and Amortized Wines": [
    { name: "Sweet Vermouth", color: "#8B000099" },
    { name: "Dry Vermouth", color: "#F5F5DC80" },
    { name: "White/Blanc Vermouth", color: "#F5F5DC99" },
  ],
  "Wines": [
    { name: "Sparkling Wine", color: "#F5F5DC80" },
    { name: "Prosecco", color: "#F5F5DC80" },
    { name: "Champagne", color: "#F5F5DC80" },
  ],
  "Sodas": [
    { name: "Ginger Beer", color: "#D2B48C80" },
    { name: "Cola", color: "#030201c7" },
  ...
  "Milk and Egg Products": [
    ...
    { name: "Egg Whites", color: "#FFFFFFB3" },
    { name: "Heavy Cream", color: "#F5F5F5CC" },
    { name: "Coconut Cream", color: "#F5F5F5B3" },
  ],
  "Plant Products": [
    { name: "Mint Sprigs", color: "#2E8B5780" },
    { name: "Mint", color: "#2E8B5780" },
    { name: "Dried Cloves", color: "#A0522D99" },
  ],
  "Coffee": [
    { name: "Espresso", color: "#3B1A0899" },
  ],
  "Other": [
